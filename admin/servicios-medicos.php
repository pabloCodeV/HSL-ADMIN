            ...
            <div>
                <table>
                    <thead>
                        ...
                        <th style="width:70%">Servicio Medico</th>
                        <th style="width:auto">Tipo</th>
                        <th>Accion <button type="button" id="agregarServicio" class="agregar" data-bs-toggle="modal"  data-bs-target="#modalAtributo">Nuevo</button></th>
                    </thead>
                    <tbody>
                    </tbody>
      ...
      <div class="modal-body">
        <form id="serviciosform" enctype="multipart/form-data">
          ...
          <label for="tipo" class="col-form-label">Tipo</label>
            <select type="text" class="form-control" id="tipoServicio" name="tipo">
              <option value="">--SELECCIONE--</option>
              <option value="0">Servicio Medico</option>
...
const nombre = document.getElementById('nombreServicio')
const tipo = document.getElementById('tipoServicio')
// *************************************************************************************
...
//CONSTANTES API ************************************************************************
// const url_prod = 'https://hospitalsiriolibanes.ar/comunicacion/api/servicioMedico/';
const url_prod="http://localhost/admin/api/servicioMedico/";
// **************************************************************************************
  ...
  .then(function (response) { 
    ...
    resultados+=`
                  <tr>
                    ...
                    <td>${atributo.tipo}</td>
                    <td><button id="borrarServicio" class="borrar">Borrar</button><button id="modificarServicio" class="modificar">Modificar</button></td>
                </tr>` 
    })
...
let idForm = 0
on(document, 'click', '#modificarServicio', e => {    
